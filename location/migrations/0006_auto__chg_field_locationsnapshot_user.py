...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocationSnapshot.user'
        db.alter_column(u'location_locationsnapshot', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'LocationSnapshot.user'
        db.alter_column(u'location_locationsnapshot', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'location.locationsnapshot': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'location_snapshots'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
