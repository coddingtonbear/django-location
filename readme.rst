.. image:: https://travis-ci.org/coddingtonbear/django-location.png?branch=master
   :target: https://travis-ci.org/coddingtonbear/django-location
...
repository <https://github.com/coddingtonbear/django-location>`__::

    git clone https://github.com/coddingtonbear/django-location.git
    cd django-location
...
-  `django-neighborhoods <http://github.com/coddingtonbear/django-neighborhoods/>`__
-  `django-census-places <http://github.com/coddingtonbear/django-census-places/>`__
...
2. Set-up Django Mailbox to consume mail from such a mailbox (consult
   `django-mailbox's
   documentation <http://github.com/coddingtonbear/django-mailbox/>`__).
...
.. image:: https://d2weczhvl823v0.cloudfront.net/coddingtonbear/django-location/trend.png
   :alt: Bitdeli badge
